...
inspect <- read_csv("./data/osha_inspection.csv")
strat_codes <- read_csv("./data/osha_strategic_codes.csv")
optional_info <- read_csv("./data/osha_optional_info.csv")
related_activity <- read_csv("./data/osha_related_activity.csv")
violations <- read_csv("./data/osha_violation.csv")
```
...
related_activity %>% mutate(rel_health = ifelse("X", TRUE, FALSE),
                            rel_safety = ifelse("X", TRUE, FALSE)))
```
